    ...
    <div className="container mx-auto px-6 max-w-7xl">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <div className="flex gap-2 mt-4">
            <Button className="flex" variant="ghost" data-testid="button-social-github" style={{ flexGrow: 1, cursor: 'pointer' }} onClick={_ => window.open('https://github.com/xDemorn/cazando-bugs', '_blank')}>
              <span>Comprueba el proyecto en </span>
